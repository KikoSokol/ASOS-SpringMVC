package com.example.springmvc.backend.user.web;
...
import com.example.springmvc.backend.user.domain.attribute.PersonalNumberParseException;
import com.example.springmvc.backend.user.web.resource.UserResource;
